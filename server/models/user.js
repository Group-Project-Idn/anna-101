...
module.exports = (sequelize, DataTypes) => {
  class User extends Model {
    static associate(models) {
      ...
      User.hasMany(models.ConversationInvite, { foreignKey: 'from_user_id', as: 'sent_invites' });
      User.hasMany(models.ConversationInvite, { foreignKey: 'to_user_id', as: 'received_invites' });
      ...
      User.hasMany(models.SessionEvaluation, { foreignKey: 'user_id', as: 'evaluations' });
    }
  }
  User.init({
    name: {
